...
export const Skill = () => {
  ...
  return (
    <>
      ...
      bg-indigo-50 flex-wrap mb-5 pb-15 " 
        ref={revealRef}
      >
        <div className="heading-div text-center mt-10 reveal ">
        ...
        <div className="flex gap-30   ">
          <div className="left-div skills-div reveal" >
            <div
          ...
          <div className="right-div skills-div  reveal">
            <div
  ...
  <div className="grid grid-cols-2 gap-10">
                {skills.map((skill, index) => (
                  <div key={index} className="Expertis-div w-[480px] flex justify-between  ">
